...
const MESSAGES = ["Nice to meet u!", "I'm Jisang.", "Let's scroll!"];
...
export default function TypingMessages({
  ...
  return (
    <span
      className={`font-nokia  leading-tight break-words text-[#2A3616]/80 ${className}`}
    >
      {text}
      <motion.span
        className="ml-[0.15em] inline-block h-[0.95em] w-[0.14em] bg-[#2A3616]/80 align-middle"
